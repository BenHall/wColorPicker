	...
	ColorPicker.prototype =
	{
		...
		appendColors: function($palette, colors, lineCount)
		{
			...
			for(index in colors)
			{
				...
				if(colorItem != 'transparent') {
					colorItem = '#' + colorItem;
				} 

				$palette.append(
					$('<div id="_wColorPicker_color_' + counter + '" class="_wColorPicker_color _wColorPicker_color_' + counter + '"></div>').css('background-color', colorItem)
					.click(function(){$this.colorSelect($this, $(this).css('background-color'));})
		...
		colorSelect: function($this, color)
		{
			...
			$this.customTarget.css('background-color', color);
			...
			if($this.buttonColor)
			{
				$this.buttonColor.css('background-color', color);
		...
		colorHoverOn: function($this, $element)
		{
			...
			var color = $this.toHex($element.css('background-color'));
		...
		colorHoverOff: function($this, $element)
		{
			...
			$this.customTarget.css('background-color', $this.currentColor);
